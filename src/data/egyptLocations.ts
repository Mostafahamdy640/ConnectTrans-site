...
export const INITIAL_SITE_CONTENT: SitePageContent = {
  ...
  heroTrackBtnText: 'تتبع حركة الشاحنات',
  ...
  companyCardTitle: 'بوابة الشركات والمصانع',
  companyCardDesc: 'تسجيل بيانات الشركة وإرسال طلبات التعاون المباشر لـ ConnectTrans، مع متابعة البوالص والرحلات.',
  companyCardBadge: 'حلول الشركات والمصانع',
  officeCardTitle: 'بوابة مكاتب النقل والوساطة',
  officeCardDesc: 'استعراض طلبات النقل المعتمدة وتقديم عروض الأسعار الرسمية وإدارة أسطول السائقين والقبولات.',
  officeCardBadge: 'مكاتب النقل والوساطة',
  driverCardTitle: 'بوابة أصحاب السيارات والشاحنات',
  driverCardDesc: 'تصفح عروض مكاتب النقل، قبول الشحنات وتحديد الكمية المناسبة، مع حماية سريعة لمستحقات المشوار.',
  driverCardBadge: 'أصحاب الشاحنات والسيارات',
  ...
  whyUsHeadline: 'لماذا يختار كبار الفاعلين في قطاع النقل منصة ConnectTrans؟',
  whyUsSubheadline: 'منظومة مصرية ذكية صممت خصيصاً لتنظيم بيئة عمل قطاع النقل الثقيل والوساطة اللوجستية بأعلى معايير الحوكمة والسرعة.',
  feature1Title: 'حماية الخصوصية وتشفير البيانات',
  feature1Desc: 'حجب كامل لبيانات الاتصال قبل التعاقد الرسمي لمنع التجاوزات وضمان حقوق كافة الشركاء بأمان تام.',
  feature2Title: 'إسناد حصص مرن وتتبع فوري',
  feature2Desc: 'توزيع الكميات الكبيرة على دفعات وسيارات متعددة مع متابعة لحظية لحركة السائقين على خرائط الطرق.',
  feature3Title: 'توثيق البوالص وإثبات التسليم الرقمي (POD)',
  feature3Desc: 'رفع فوري لصور إيصالات الاستلام وبوالص الشحن عبر المنصة مع صرف مستحقات المشاوير دون تأخير.',
  ...
  footerPrivacyNotice: 'كافة بيانات الشاحنات وأرقام الهواتف مشفرة ومحمية بموجب قانون حماية البيانات واللوائح المنظمة لقطاع النقل.',
