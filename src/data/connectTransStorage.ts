  ...
  trips: [
    {
      ...
      currentLat: 29.8450,
      currentLng: 31.4200,
      currentRoadName: 'طريق القطامية - السخنة السريع (الكيلو ٤٢)',
      currentSpeedKmH: 74,
      ...
      privateTrackingPin: '9102',
      officeNotes: 'توجيه المكتب: تفادي الدوران المزدحم عند بوابة الرسوم واستخدام حارة النقل الثقيل اليسرى',
      driverStatusNote: 'السائق: تم اجتياز محطة تحصيل الرسوم بسلام، ضغط الإطارات ممتاز والشاحنة متزنة',
      createdAt: '2026-02-01T11:20:00Z',
      startedAt: '2026-02-01T14:30:00Z'
    },
    {
      id: 'trip-503',
      tripNumber: 'TRIP-EG-9180',
      requestId: 'req-1002',
      acceptanceId: 'acc-302',
      shipperId: 'comp-el-araby-ind',
      shipperName: 'الشركة الشرقية للتجارة والتوزيع',
      shipperRole: 'company',
      transporterId: 'office-delta-transport',
      transporterName: 'مكتب الدلتا للشحن والنقل البري',
      transporterRole: 'office',
      driverId: 'drv-203',
      driverName: 'محمود عزت النجار',
      driverPhone: '01223344556',
      vehiclePlate: 'س ق م ٧٣٥١',
      fromLocation: 'ميناء الإسكندرية (باب ١٠)',
      toLocation: 'العاشر من رمضان (المنطقة الصناعية B1)',
      cargoType: 'حاويات خامات بلاستيك وبوليمرات (28 طن)',
      quantity: 1,
      status: 'in_progress',
      statusHistory: [
        { status: 'pending', timestamp: '2026-02-02T07:00:00Z', note: 'إنشاء أمر التحميل' },
        { status: 'in_progress', timestamp: '2026-02-02T09:30:00Z', note: 'مغادرة الميناء والتحرك على الطريق الصحراوي' }
      ],
      currentLocation: 'طريق مصر الإسكندرية الصحراوي (قرب وادي النطرون)',
      originLat: 31.1894,
      originLng: 29.8656,
      destLat: 30.3015,
      destLng: 31.7431,
      currentLat: 30.7500,
      currentLng: 30.6500,
      currentRoadName: 'طريق القاهرة - الإسكندرية الصحراوي (الكيلو ١١٠)',
      currentSpeedKmH: 82,
      ...
      commission: 0,
      isPrivateDispatchOnly: true,
      privateTrackingPin: '9180',
      officeNotes: 'توجيه المكتب: التسليم بمستودع العاشر من رمضان قبل الساعة ٤ عصراً لضمان سرعة التفريغ',
      driverStatusNote: 'السائق: السرعة منتظمة 80 كم/س والحاوية مقفلة برصاص الجمارك وسليمة',
      createdAt: '2026-02-02T07:00:00Z',
      startedAt: '2026-02-02T09:30:00Z'
    },
    {
      id: 'trip-504',
      tripNumber: 'TRIP-EG-9214',
      requestId: 'req-1003',
      acceptanceId: 'acc-303',
      shipperId: 'comp-nile-pack',
      shipperName: 'مصانع الأهرام للزجاج والبلور',
      shipperRole: 'company',
      transporterId: 'owner-ahmed-mansour',
      transporterName: 'أسطول الإيمان للنقل المبرد',
      transporterRole: 'vehicle_owner',
      driverId: 'drv-204',
      driverName: 'عصام عبد الفتاح',
      driverPhone: '01122998877',
      vehiclePlate: 'د ف هـ ٦١٤٨',
      fromLocation: 'مدينة السادات (المنوفية)',
      toLocation: 'ميناء دمياط (رصيف الحاويات)',
      cargoType: 'عبوات زجاجية وتغليف مفرغ (20 طن)',
      quantity: 1,
      status: 'assigned',
      statusHistory: [
        { status: 'pending', timestamp: '2026-02-02T10:00:00Z' },
        { status: 'assigned', timestamp: '2026-02-02T10:30:00Z', note: 'الشاحنة جاهزة في ساحة التحميل بمصنع السادات' }
      ],
      currentLocation: 'المنطقة الصناعية بالسادات (ساحة المستودعات)',
      originLat: 30.3792,
      originLng: 30.5050,
      destLat: 31.4500,
      destLng: 31.7600,
      currentLat: 30.3850,
      currentLng: 30.5120,
      currentRoadName: 'مدخل السادات الصناعي - انتظار أوراق الشحن',
      currentSpeedKmH: 0,
      ...
      commission: 0,
      isPrivateDispatchOnly: true,
      privateTrackingPin: '9214',
      officeNotes: 'توجيه المكتب: التدقيق في فحص سلامة العبوات الزجاجية وربط الأشرطة المطاطية جيداً قبل التحرك',
      driverStatusNote: 'السائق: جاري استلام البوليصة من إدارة المستودعات والتحرك خلال ١٥ دقيقة',
      createdAt: '2026-02-02T10:00:00Z'
    },
    {
      id: 'trip-502',
      ...
      currentLocation: 'ميناء الإسكندرية (تم الوصول والتفريغ)',
      originLat: 30.3015,
      originLng: 31.7431,
      destLat: 31.1894,
      destLng: 29.8656,
      currentLat: 31.1894,
      currentLng: 29.8656,
      currentRoadName: 'رصيف تفريغ ميناء الإسكندرية (تم الإنهاء)',
      currentSpeedKmH: 0,
    ...
    {
      id: 'trip-505',
      tripNumber: 'TRIP-EG-7920',
      requestId: 'req-past-98',
      acceptanceId: 'acc-past-98',
      shipperId: 'comp-cement-heavy',
      shipperName: 'شركة حلوان للأسمنت ومواد البناء',
      shipperRole: 'company',
      transporterId: 'office-cairo-express',
      transporterName: 'شركة الصعيد للشحن الثقيل',
      transporterRole: 'office',
      driverId: 'drv-205',
      driverName: 'رمضان السوهاجي',
      driverPhone: '01099887766',
      vehiclePlate: 'ص ع د ٤٢١٩',
      fromLocation: 'حلوان (جنوب القاهرة)',
      toLocation: 'أسيوط الجديدة (المنطقة الصناعية)',
      cargoType: 'أسمنت سائب ومعدات خرسانة (32 طن)',
      quantity: 1,
      status: 'completed',
      statusHistory: [
        { status: 'pending', timestamp: '2026-01-25T06:00:00Z' },
        { status: 'in_progress', timestamp: '2026-01-25T07:30:00Z' },
        { status: 'completed', timestamp: '2026-01-25T17:00:00Z', note: 'تم التسليم في الموعد المحدد واستلام توقيع المستلم' }
      ],
      currentLocation: 'أسيوط الجديدة (موقع الإنشاء)',
      originLat: 29.8499,
      originLng: 31.3342,
      destLat: 27.1801,
      destLng: 31.1837,
      ...
      startedAt: '2026-01-25T07:30:00Z',
    ...
    {
      id: 'trip-506',
      tripNumber: 'TRIP-EG-7840',
      requestId: 'req-past-97',
      acceptanceId: 'acc-past-97',
      shipperId: 'comp-suez-steel',
      shipperName: 'الشركة المصرية لمنتجات الصلب والحديد',
      shipperRole: 'company',
      transporterId: 'owner-ahmed-mansour',
      transporterName: 'أسطول الدلتا للنقل المباشر',
      transporterRole: 'vehicle_owner',
      driverId: 'drv-206',
      driverName: 'علاء عبد العظيم',
      driverPhone: '01555443322',
      vehiclePlate: 'ق هـ ط ٥٩٢١',
      fromLocation: 'العين السخنة (السويس)',
      toLocation: 'قويسنا (المنوفية)',
      cargoType: 'لفائف حديد ومسطحات مجلفنة (26 طن)',
      quantity: 1,
      status: 'completed',
      statusHistory: [
        { status: 'pending', timestamp: '2026-01-22T08:00:00Z' },
        { status: 'in_progress', timestamp: '2026-01-22T09:45:00Z' },
        { status: 'completed', timestamp: '2026-01-22T16:15:00Z', note: 'تم التفريغ بسلام ومطابقة البوليصة مع أمر التوريد' }
      ],
      currentLocation: 'المنطقة الصناعية بقويسنا (تم التفريغ)',
      originLat: 29.6000,
      originLng: 32.3167,
      destLat: 30.5606,
      destLng: 31.1444,
      ...
      startedAt: '2026-01-22T09:45:00Z',
      completedAt: '2026-01-22T16:15:00Z',
      ratedByShipper: true,
      ratedByTransporter: true
    }
  ],
...
export class ConnectTransStorage {
  ...
  public createAgreedTransportOrder(params: {
    ...
    const newRequest: TransportRequest = {
      ...
      creatorType: 'company',
      creatorGovernorate: params.fromGovernorate,
      creatorCity: params.fromCity,
      requestType: 'direct_connecttrans',
      ...
      pickupLocation: `${params.fromGovernorate} - ${params.fromCity}`,
      dropoffLocation: `${params.toGovernorate} - ${params.toCity}`,
